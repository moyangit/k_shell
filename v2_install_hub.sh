...
sudo docker pull automsen/tv2:4.31.0
echo "---end ------"
...
sudo wget -P /docker/tv2  https://gitee.com/t_deploy/shell_v2/raw/master/v2config/config.json
...
--restart=always automsen/tv2:4.31.0
...
sudo docker pull automsen/tpr:$5-SNAPSHOT
echo "---end ------"
